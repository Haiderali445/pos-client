    ...
    try {
      ...
      if (created) {
        await posDb.products.put({
          ...
          salePrice: Number(created.salePrice !== undefined ? created.salePrice : created.price || 0),
          price: Number(created.salePrice !== undefined ? created.salePrice : created.price || 0),
          ...
          sku: created.sku ? String(created.sku).trim().toUpperCase() : "",
          reorderLevel: Number(created.reorderLevel || 5),
          image: created.image || "",
